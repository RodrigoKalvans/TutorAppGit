        ...
        <div className="w-full">
            <form onSubmit={(e) => search(e)} className="form-control w-full flex-row relative text-black-800">
                <div className="relative flex items-center">
                    ...
                    <input onChange={(e) => setQuery(e.target.value)} type="search" id="search" className="w-full p-3 pl-10 rounded-l-full bg-white-200 text-black" placeholder="Search" required>
