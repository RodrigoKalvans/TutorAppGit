...
export default function Navbar() {
  return (
    <nav className="navbar m-5 px-10 p-3 w-4/5 p-1 flex justify-between rounded-full bg-transparent text-white">
      <span className="">
      ...
      <span className="form-control w-1/5 pl-3 flex-row relative text-black-800">
        <div className="relative">
          ...
          <input type="search" id="search" className="block w-full p-3 pl-10 rounded-full bg-white-200 " placeholder="Search" required></input>
