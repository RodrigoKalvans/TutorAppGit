...
export default function Navbar() {
  return (
    <nav className="navbar px-10 p-3 w-4/5 p-1 content-center flex justify-between rounded-full bg-transparent text-white">
      ...
      {/** search field */}
      <span className="form-control w-1/4 flex-row relative text-black-800">
        <div className="relative flex">
          ...
          <input type="search" id="search" className="block w-4/5 p-3 pl-10 rounded-full bg-white-200 text-black" placeholder="Search" required></input>
